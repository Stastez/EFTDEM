...
/**
 * Calculates the average of all heights in an area of size kernelSize in every direction around the the pixel,
 * using the precalculated sum and amount of the non-void pixels in this area.
 */
void main() {
